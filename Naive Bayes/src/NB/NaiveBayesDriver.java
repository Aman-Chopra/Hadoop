...
public class NaiveBayesDriver extends Configured implements Tool {
    ...
    private final static String CLUSTER_OUTPUT_PATH = "hdfs://localhost:54310/user/hduser/naiveOutput/";
    private final static String DATAPATH = "hdfs://localhost:54310/user/hduser/naiveInput.txt";
    static {
